...
├── terminal-sidebar.html   # Recent notes navigation - pure Tailwind (24 LOC)
...
| `terminal-sidebar.html` | terminal-layout | Left sidebar recent notes list (pure Tailwind) |
...
| Modify sidebar notes | `terminal-sidebar.html` | Shows recent 15 notes, pure Tailwind hover |
...
| TOC functionality | Use `<terminal-toc>` web component | Include is deleted, use web component |
...
**`page_sidebar/toc.html` DELETED** - Use `<terminal-toc>` web component everywhere.
...
|---------|--------|-------------|
| `page_sidebar/toc.html` | Duplicate functionality | Use `<terminal-toc>` web component |
