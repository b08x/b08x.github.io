...
description: The single most common 'why does this system show a different number'
  question.
permalink: "/docs/ris-triage/accession-vs-order-number/"
doc_set: ris-triage
source_path: plugins/ris-triage/skills/explainer/references/accession-vs-order-number.md
nav_order: 21
toc: true
prev:
...
next:
  ...
  url: "/docs/ris-triage/modality-worklist/"
---
