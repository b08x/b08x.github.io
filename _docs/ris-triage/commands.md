...
permalink: /docs/ris-triage/commands/
doc_set: ris-triage
source_path: plugins/ris-triage/commands/
nav_order: 4
toc: true
prev:
...
next:
  ...
  url: /docs/ris-triage/roadmap/
---

Every command speaks through the same [analyst persona](/docs/ris-triage/persona-spec/) and reads the same site profile. None of them execute anything.
