...
description: How studies reach the scanner, and what an empty worklist actually means.
permalink: "/docs/ris-triage/modality-worklist/"
doc_set: ris-triage
source_path: plugins/ris-triage/skills/explainer/references/modality-worklist.md
nav_order: 22
toc: true
prev:
  title: Accession vs. order number
  url: "/docs/ris-triage/accession-vs-order-number/"
next:
  title: Report status flow
  url: "/docs/ris-triage/report-status-flow/"
---
