...
title: Non-goals
description: What this deliberately does not do, and why the boundary sits there.
permalink: "/docs/ris-triage/non-goals/"
doc_set: ris-triage
source_path: docs/NON-GOALS.md
nav_order: 32
toc: true
prev:
  title: Guardrails
  url: "/docs/ris-triage/guardrails/"
next:
  title: Data provenance
  url: "/docs/ris-triage/data-provenance/"
---

What RIS Triage will not do, stated as plainly as what it will. These are design
...
RIS Triage drafts, decodes, and recommends. It has no path to a state-changing
...
Every output separates what the message or record *says* from what RIS Triage
...
handed to a human. RIS Triage does not weigh clinical trade-offs.
...
[ADR-0008](/docs/ris-triage/adr-0008-separate-forensics-plugin/) and
[FORENSICS-BACKLOG.md](https://github.com/b08x/ris_triage/blob/main/docs/FORENSICS-BACKLOG.md).
...
enter this repository. See [DATA-PROVENANCE.md](/docs/ris-triage/data-provenance/).
...
institutional knowledge that has never been written down. Where RIS Triage helps,
