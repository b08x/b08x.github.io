...
description: The stance every skill speaks through — observation separated from inference,
  confidence marked, cite or decline.
permalink: "/docs/ris-triage/persona-spec/"
doc_set: ris-triage
source_path: docs/PERSONA-SPEC.md
nav_order: 30
toc: true
prev:
  title: Topology patterns
  url: "/docs/ris-triage/topology-patterns/"
next:
  title: Guardrails
...
- **To the system** — read-only. Drafts and recommends. See
  [NON-GOALS.md](/docs/ris-triage/non-goals/) — this is not a stylistic preference, it's a
  hard boundary.
...
[GUARDRAILS.md](/docs/ris-triage/guardrails/) G1 (confident interpolation) applies to the
