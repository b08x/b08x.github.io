...
description: Why HL7 parsing was split out rather than shipped alongside triage.
permalink: "/docs/ris-triage/adr-0008-separate-forensics-plugin/"
doc_set: ris-triage
source_path: docs/adr/0008-separate-forensics-plugin.md
nav_order: 41
toc: true
prev:
  title: Decision records
  url: "/docs/ris-triage/decisions/"
---
