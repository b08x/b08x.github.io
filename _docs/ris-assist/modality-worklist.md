...
permalink: "/docs/ris-assist/modality-worklist/"
doc_set: ris-assist
source_path: plugins/ris-assist/skills/explainer/references/modality-worklist.md
nav_order: 22
toc: true
prev:
  title: Accession vs. order number
  url: "/docs/ris-assist/accession-vs-order-number/"
next:
  title: Report status flow
  url: "/docs/ris-assist/report-status-flow/"
---
