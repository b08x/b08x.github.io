...
permalink: /docs/ris-assist/site-profile/
doc_set: ris-assist
source_path: plugins/ris-assist/skills/setup/SKILL.md
nav_order: 3
toc: true
prev:
  title: Installing
  url: /docs/ris-assist/installing/
next:
  title: Commands
...
A fictional site — Riverside Regional Imaging — demonstrates every schema field in [`plugins/ris-assist/examples/site-profile.example.yaml`](https://github.com/b08x/ris_assist/blob/main/plugins/ris-assist/examples/site-profile.example.yaml). Every name in it is invented; see [data provenance](/docs/ris-assist/data-provenance/).
