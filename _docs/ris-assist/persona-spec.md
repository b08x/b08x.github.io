...
permalink: "/docs/ris-assist/persona-spec/"
doc_set: ris-assist
...
prev:
  ...
  url: "/docs/ris-assist/topology-patterns/"
next:
  title: Guardrails
  url: "/docs/ris-assist/guardrails/"
---
...
- **To the system** — read-only. Drafts and recommends. See
  [NON-GOALS.md](/docs/ris-assist/non-goals/) — this is not a stylistic preference, it's a
  hard boundary.
...
[GUARDRAILS.md](/docs/ris-assist/guardrails/) G1 (confident interpolation) applies to the
