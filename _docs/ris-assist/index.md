...
RIS Assist packages that analyst's working method as a [Claude](https://claude.com/claude-code) plugin.
...
[Status and roadmap](/docs/ris-assist/roadmap/) separates what runs today from what is decided but unbuilt, and from what is parked on purpose.
