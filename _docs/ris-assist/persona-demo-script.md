...
description: The narrative script accompanying the persona interactive demo.
permalink: "/docs/ris-assist/persona-demo-script/"
doc_set: ris-assist
source_path: demo/persona-narration.md
nav_order: 36
toc: true
prev:
