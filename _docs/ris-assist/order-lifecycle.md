...
description: ordered → scheduled → performed → read → reported, and what breaks between
  each step.
permalink: "/docs/ris-assist/order-lifecycle/"
doc_set: ris-assist
source_path: plugins/ris-assist/skills/explainer/references/order-lifecycle.md
nav_order: 20
toc: true
next:
