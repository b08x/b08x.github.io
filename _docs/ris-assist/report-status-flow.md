...
description: Draft, preliminary, signed, finalized — and where reports get stuck.
permalink: "/docs/ris-assist/report-status-flow/"
doc_set: ris-assist
source_path: plugins/ris-assist/skills/explainer/references/report-status-flow.md
nav_order: 23
toc: true
prev:
  title: Modality worklist
  url: "/docs/ris-assist/modality-worklist/"
next:
