...
file_paths:
- path: src/video_chapter_automater/preprocessing/audio_extractor.py
  url: https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/preprocessing/audio_extractor.py
- path: src/video_chapter_automater/preprocessing/video_encoder.py
  url: https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/preprocessing/video_encoder.py
- path: src/video_chapter_automater/preprocessing/strategies/hash_strategies.py
  url: https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/preprocessing/strategies/hash_strategies.py
pagination:
  previous:
...
Sources: [src/video_chapter_automater/pipeline/config.py:#L21-L30](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/config.py#L21-L30), [src/video_chapter_automater/pipeline/orchestrator.py:#L1-L10](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/orchestrator.py#L1-L10)
...
Sources: [src/video_chapter_automater/pipeline/config.py:#L66-L85](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/config.py#L66-L85), [src/video_chapter_automater/pipeline/orchestrator.py:#L45-L65](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/orchestrator.py#L45-L65), [src/video_chapter_automater/output/manager.py:#L65-L85](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/output/manager.py#L65-L85)
...
```
Sources: [src/video_chapter_automater/pipeline/orchestrator.py:#L100-L125](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/orchestrator.py#L100-L125), [src/video_chapter_automater/pipeline/stage.py:#L80-L90](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/stage.py#L80-L90)
...
Sources: [src/video_chapter_automater/pipeline/config.py:#L21-L30](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/config.py#L21-L30), [src/video_chapter_automater/pipeline/stage.py:#L77-L82](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/stage.py#L77-L82), [src/video_chapter_automater/output/manager.py:#L14-L25](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/output/manager.py#L14-L25)
...
Sources: [src/video_chapter_automater/pipeline/config.py:#L55-L65](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/config.py#L55-L65)
...
sequenceDiagram
    ...
    deactivate Orch
```
Sources: [src/video_chapter_automater/pipeline/orchestrator.py:#L100-L140](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/orchestrator.py#L100-L140), [src/video_chapter_automater/pipeline/stage.py:#L10-L40](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/stage.py#L10-L40)
...
Sources: [src/video_chapter_automater/pipeline/config.py:#L45-L55](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/config.py#L45-L55), [src/video_chapter_automater/pipeline/config.py:#L100-L110](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/pipeline/config.py#L100-L110)
...
```
Sources: [src/video_chapter_automater/output/manager.py:#L100-L110](https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/output/manager.py#L100-L110)
