...
file_paths:
- path: bootstrap.sh
  url: https://github.com/b08x/omega-13/blob/main/bootstrap.sh
- path: README.md
  url: https://github.com/b08x/omega-13/blob/main/README.md
- path: pyproject.toml
  url: https://github.com/b08x/omega-13/blob/main/pyproject.toml
pagination:
  previous:
...
Sources: [src/omega13/app.py:#L57-L80](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L57-L80), [README.md:#L76-L85](https://github.com/b08x/omega-13/blob/main/README.md#L76-L85)
...
```
Sources: [src/omega13/app.py:#L125-L150](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L125-L150), [src/omega13/audio.py:#L22-L40](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L22-L40)
...
Sources: [src/omega13/config.py:#L14-L40](https://github.com/b08x/omega-13/blob/main/src/omega13/config.py#L14-L40), [src/omega13/audio.py:#L18-L55](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L18-L55), [src/omega13/session.py:#L45-L60](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L45-L60), [src/omega13/transcription.py:#L45-L65](https://github.com/b08x/omega-13/blob/main/src/omega13/transcription.py#L45-L65)
...
Sources: [src/omega13/config.py:#L30-L45](https://github.com/b08x/omega-13/blob/main/src/omega13/config.py#L30-L45), [src/omega13/audio.py:#L15-L16](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L15-L16)
...
```
Sources: [src/omega13/app.py:#L175-L200](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L175-L200), [README.md:#L60-L75](https://github.com/b08x/omega-13/blob/main/README.md#L60-L75)
...
Sources: [src/omega13/transcription.py:#L66-L85](https://github.com/b08x/omega-13/blob/main/src/omega13/transcription.py#L66-L85), [src/omega13/session.py:#L1-L30](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L1-L30), [src/omega13/config.py:#L40-L45](https://github.com/b08x/omega-13/blob/main/src/omega13/config.py#L40-L45)
