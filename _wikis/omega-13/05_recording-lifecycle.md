...
file_paths:
- path: src/omega13/recording_controller.py
  url: https://github.com/b08x/omega-13/blob/main/src/omega13/recording_controller.py
pagination:
  previous:
...
Sources: [src/omega13/audio.py:#L21-L40](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L21-L40), [README.md:#L63-L67](https://github.com/b08x/omega-13/blob/main/README.md#L63-L67)
...
```
Sources: [src/omega13/audio.py:#L18-L35](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L18-L35)
...
Sources: [src/omega13/audio.py:#L56-L70](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L56-L70), [src/omega13/app.py:#L221-L235](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L221-L235)
...
Sources: [src/omega13/app.py:#L221-L245](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L221-L245), [src/omega13/audio.py:#L1-L40](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L1-L40), [src/omega13/session.py:#L110-L125](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L110-L125)
...
Sources: [src/omega13/audio.py:#L55-L65](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py#L55-L65), [src/omega13/session.py:#L88-L95](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L88-L95), [src/omega13/app.py:#L105-L110](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L105-L110)
...
Sources: [src/omega13/session.py:#L175-L195](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L175-L195), [README.md:#L45-L50](https://github.com/b08x/omega-13/blob/main/README.md#L45-L50)
...
Sources: [src/omega13/session.py:#L177-L185](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L177-L185), [tests/test_incremental_save.py:#L30-L45](https://github.com/b08x/omega-13/blob/main/tests/test_incremental_save.py#L30-L45)
...
Sources: [src/omega13/audio.py](https://github.com/b08x/omega-13/blob/main/src/omega13/audio.py), [src/omega13/app.py](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py)