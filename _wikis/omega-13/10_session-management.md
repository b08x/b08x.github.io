...
file_paths:
- path: src/omega13/session.py
  url: https://github.com/b08x/omega-13/blob/main/src/omega13/session.py
- path: tests/test_incremental_save.py
  url: https://github.com/b08x/omega-13/blob/main/tests/test_incremental_save.py
pagination:
  previous:
    title: '09-tui-and-ux'
...
Sources: [src/omega13/session.py:#L1-L15](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L1-L15), [src/omega13/app.py:#L1-L25](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L1-L25)
...
Sources: [src/omega13/session.py:#L22-L140](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L22-L140)
...
```
Sources: [src/omega13/session.py:#L145-L180](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L145-L180), [src/omega13/app.py:#L30-L50](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L30-L50)
...
Sources: [src/omega13/session.py:#L185-L210](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L185-L210), [tests/test_deduplication.py:#L10-L35](https://github.com/b08x/omega-13/blob/main/tests/test_deduplication.py#L10-L35)
...
Sources: [src/omega13/session.py:#L215-L245](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L215-L245), [tests/test_incremental_save.py:#L20-L50](https://github.com/b08x/omega-13/blob/main/tests/test_incremental_save.py#L20-L50)
...
sequenceDiagram
    ...
    SM-->>-UI: True
```
Sources: [src/omega13/app.py:#L100-L120](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py#L100-L120), [src/omega13/session.py:#L260-L290](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py#L260-L290)
...
Sources: [CHANGELOG.md](https://github.com/b08x/omega-13/blob/main/CHANGELOG.md), [src/omega13/session.py](https://github.com/b08x/omega-13/blob/main/src/omega13/session.py)