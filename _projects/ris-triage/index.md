...
links:
  - label: "coverage demo"
    url: "/ris-triage/coverage-demo.html"
    internal: true
  - label: "analyst persona"
    url: "/ris-triage/persona-card.html"
    internal: true
---
...
Every skill speaks through one [analyst persona](/ris-triage/persona-card.html): observation separated from inference, every diagnostic conclusion marked *confirmed / likely / possible*, anything absent from the site profile declared absent rather than given a plausible fiction.

{% include audio-overview.html audio="/assets/audio/ris-triage/full.mp3" manifest="/assets/audio/ris-triage/manifest.json" %}
