---
layout: page
title: Applications Used in the Environment
subtitle: 
excerpt: 
category: 
tags:
...
|:----------------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------------------------------------------------------|
| [Ray Session](https://github.com/Houston4444/RaySession): | &nbsp;A powerful session manager for audio applications | Control and manage multiple applications from a single interface. Also controls networked devices |
|                                                           |                                                         |                                                                                                   |
|                                                           |                                                         |                                                                                                   |
|                                                           |                                                         |                                                                                                   |
|                                                           |                                                         |                                                                                                   |
