...
layout: note
title: monadic chat
subtitle: a Ruby framework for chatbot clients
category: 
tags: 
links:
---
...
[example user application](https://github.com/b08x/monadic-chat-cli/blob/development/user_apps/steve/steve.rb)

---

* on the dokku host, run ansible-pull playbooks/dokku.yml -e 'app=monadic' to deploy an instance of monadic-chat
