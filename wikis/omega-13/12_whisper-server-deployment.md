...
file_paths:
- path: Containerfile
  url: https://github.com/b08x/omega-13/blob/main/Containerfile
- path: compose.yml
...
Sources: [compose.yml](https://github.com/b08x/omega-13/blob/main/compose.yml), [src/omega13/transcription.py:#L1-L15](https://github.com/b08x/omega-13/blob/main/src/omega13/transcription.py#L1-L15), [README.md](https://github.com/b08x/omega-13/blob/main/README.md)
...
| :--- | :--- | :--- |
| Base Image | `whisper-server-cuda:latest` | [compose.yml:#L5](https://github.com/b08x/omega-13/blob/main/compose.yml#L5) |
| Port Mapping | `8080:8080` | [compose.yml:#L14-L15](https://github.com/b08x/omega-13/blob/main/compose.yml#L14-L15) |
| GPU Access | `nvidia.com/gpu=all` | [compose.yml:#L51-L52](https://github.com/b08x/omega-13/blob/main/compose.yml#L51-L52) |
| Memory Limit | `12G` | [compose.yml:#L61](https://github.com/b08x/omega-13/blob/main/compose.yml#L61) |
| Default Threads | `8` | [compose.yml:#L42](https://github.com/b08x/omega-13/blob/main/compose.yml#L42) |

Sources: [compose.yml:#L5-L61](https://github.com/b08x/omega-13/blob/main/compose.yml#L5-L61)
...
Sources: [src/omega13/transcription.py:#L51-L75](https://github.com/b08x/omega-13/blob/main/src/omega13/transcription.py#L51-L75), [src/omega13/app.py](https://github.com/b08x/omega-13/blob/main/src/omega13/app.py)
...
Sources: [compose.yml:#L26-L45](https://github.com/b08x/omega-13/blob/main/compose.yml#L26-L45)
...
Sources: [compose.yml:#L19-L20](https://github.com/b08x/omega-13/blob/main/compose.yml#L19-L20), [src/omega13/transcription.py:#L48](https://github.com/b08x/omega-13/blob/main/src/omega13/transcription.py#L48), [src/omega13/config.py:#L30](https://github.com/b08x/omega-13/blob/main/src/omega13/config.py#L30)
...
Sources: [compose.yml](https://github.com/b08x/omega-13/blob/main/compose.yml), [README.md](https://github.com/b08x/omega-13/blob/main/README.md), [CHANGELOG.md](https://github.com/b08x/omega-13/blob/main/CHANGELOG.md)