...
file_paths:
- path: src/video_chapter_automater/output/manager.py
  url: https://github.com/b08x/video-chapter-automater/blob/main/src/video_chapter_automater/output/manager.py
pagination:
  previous:
