...
Jekyll::Hooks.register [:prompts], :post_convert do |doc|
  convert_links(doc)
end

Jekyll::Hooks.register [:docs], :post_convert do |doc|
  convert_links(doc)
end

Jekyll::Hooks.register [:casts], :post_convert do |doc|
  convert_links(doc)
end
...
def convert_links(doc)
  ...
  return unless open_external_links_in_new_tab
